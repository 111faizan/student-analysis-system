...
<html lang="en">	
<head>
	<title>My Courses | Student Analysis System</title>
  ...
  <header class="topbar">
      <div class="container">
        <div class="row">
          <!-- social icon-->
          <div class="col-sm-12">
		  <p style="color: white; margin-top:25px; float: right; font-size:20px; margin-bottom:15px; margin-right:465px; text-transform: uppercase;">Student Analysis System</p>
