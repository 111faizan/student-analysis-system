...
<html lang="en">	
<head>
	<title>Teacher | Student Analysis System</title>
  ...
  <header class="topbar">
      ...
      <div class="container">
        ...
        <div class="row">
		 ...
		 <p style="color: white; margin-top:25px; float: right; font-size:25px; margin-bottom:15px; margin-right:465px; text-transform: uppercase;">Student Analysis System</p>
